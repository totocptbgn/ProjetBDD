...
INSERT INTO Athlete (NomAthlete, Pays, IDSport, sexe, age) VALUES
  ...
  ('Haroldo Araújo', 'Portugal', 13, 'Homme', 31),
  ('Benjamín Amengual', 'Espagne', 5, 'Homme', 18),
  ('Barthélemy Soyer', 'France', 12, 'Homme', 30),
  ('Zhong Qing', 'Chine', 7, 'Femme', 20),
  ('Bailey Phillips', 'Etats Unis', 8, 'Homme', 17),
  ('Jia Shuren', 'Chine', 10, 'Femme', 33),
  ('Martín Venegas', 'Espagne', 12, 'Homme', 28),
  ('Ortensio Squillante', 'Italie', 4, 'Homme', 26),
  ('Kamei Mari', 'Japon', 11, 'Femme', 33),
  ('Quan Zhou', 'Chine', 13, 'Femme', 32),
  ('Uranio Cassella', 'Italie', 8, 'Homme', 29),
  ('Dorotéia Águas', 'Portugal', 11, 'Femme', 28),
  ('Layne Peters', 'Etats Unis', 2, 'Homme', 28),
  ('Estela Montenegro', 'Portugal', 1, 'Femme', 23),
  ('Julian Espiga', 'Espagne', 10, 'Homme', 23),
  ('Qin Xiang', 'Chine', 9, 'Femme', 21),
  ('Jairo Tasis', 'Espagne', 3, 'Homme', 32),
  ('Quentin Chappuis', 'France', 13, 'Homme', 26),
  ('Attilano Stellato', 'Italie', 2, 'Homme', 19),
  ('Azariah Pennington', 'Etats Unis', 9, 'Femme', 20),
  ('Silvia Almeida', 'Portugal', 1, 'Femme', 28),
  ('Ru Young-Shik', 'Corée Du Sud', 11, 'Homme', 28),
  ('Nam Seung-Hyun', 'Corée Du Sud', 11, 'Homme', 35),
  ('Richard Ancel', 'France', 13, 'Homme', 26),
  ('Magda Manera', 'Italie', 5, 'Femme', 30),
  ('Renatta Thompson', 'Jamaique', 13, 'Femme', 18);
