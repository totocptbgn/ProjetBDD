...
INSERT INTO Athlete (NomAthlete, Pays, IDSport, sexe, age) VALUES
  ...
  ('Jean-Claude Garreau', 'France', 0, 'Homme', 35),
  ...
  ('Tan Yi', 'Chine', 0, 'Femme', 32),
  ('Veronika Bürger', 'Allemagne', 0, 'Femme', 27),
  ...
  ('Alonzo Sancho', 'Espagne', 0, 'Homme', 30),
  ...
  ('Giusto Gregorio', 'Italie', 0, 'Homme', 29),
  ...
  ('Galya Denisovna', 'Russie', 0, 'Femme', 30),
  ...
  ('Iosif Valerianovich', 'Russie', 0, 'Homme', 29),
  ('Elena Waldschmidt', 'Allemagne', 0, 'Femme', 23),
  ...
  ('Gordiano Vitacco', 'Italie', 0, 'Homme', 25),
